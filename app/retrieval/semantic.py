...
_FAISS_IDX = Path(r"C:\Users\krishna.sreekumar\Downloads\Indian_Legal_Analysis\app\retrieval\faiss.index")
_CASE_IDS  = Path(r"C:\Users\krishna.sreekumar\Downloads\Indian_Legal_Analysis\app\retrieval\case_ids.json")
